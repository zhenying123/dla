...
def run(args,logger):
    ...
    if args.pre_train == 0:
        ...
        fairsad_trainer.generate_embeddings(fair_dataset)
...
#         fairsad_trainer.plot_embeddings_both(selected_embeddings, selected_labels,selected_sens,datasetname=args.dataset)
        ...
        training_time = end_time - start_time  # 计算训练所用时间
        print(f"Training time for seed {seed}: {training_time:.2f} seconds")
