...
# python train.py --dropout 0.5 --hidden 16 --lr 1e-3 --epochs 400 --model adagcn --dataset credit --seed_num 2 --alpha 0.5 --beta 0.5 --pre_train 0 --device 0 --avg True --rs 7 --per 0.4 --adv 1
...
# python train.py --dropout 0.5 --hidden 16 --lr 1e-3 --epochs 600 --model adagcn --dataset bail --seed_num 2 --alpha 0.001 --beta 0.05 --pre_train 0 --device 3 --avg True --rs 5 --per 1.2 --adv 0
# python train.py --dropout 0.5 --hidden 16 --lr 1e-2 --epochs 600 --model adagcn --dataset german --seed_num 2 --alpha 0.1 --beta 0.001 --pre_train 0 --device 0 --avg True --rs 2 --per 0.2 --adv 0
...
# python train.py --dropout 0.5 --hidden 16 --lr 1e-2 --epochs 400 --model adagcn --dataset german --pre_seed 0 --alpha 0.1 --beta 0.2 --pre_train 1 --device 0
